...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <article className="rounded-panel-lg border border-line-soft bg-panel p-3 shadow-panel transition-transform duration-150 ease-fluid hover:-translate-y-0.5 sm:p-4">
      <ProductCardImage
