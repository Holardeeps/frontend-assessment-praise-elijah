...
export function ProductCard({ product, href }: ProductCardProps) {
  ...
  return (
    <article className="rounded-panel-lg border border-line-soft bg-panel p-3 shadow-panel transition-transform duration-150 ease-fluid hover:-translate-y-0.5 focus-within:-translate-y-0.5 focus-within:border-line-strong sm:p-4">
      ...
      <Link href={href} className="block h-full rounded-panel-lg focus-visible:outline-none">
        <ProductCardImage
        ...
        <div className="mt-4 flex flex-col gap-3 xs:flex-row xs:items-start xs:justify-between">
          ...
          <div className="shrink-0 self-start rounded-full border border-line-soft bg-panel-soft px-3 py-2 text-sm font-semibold text-ink">
